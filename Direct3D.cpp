...
HRESULT Direct3D::InitShader()
{
	...
	hr = pDevice_->CreatePixelShader(pCompilePS->GetBufferPointer(), pCompilePS->GetBufferSize(), NULL, &pPixelShadera_);
	if (FAILED(hr))
	{
		//エラー処理
	...
	pContext_->PSSetShader(pPixelShadera_, NULL, 0);	//ピクセルシェーダー
